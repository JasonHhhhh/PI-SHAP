function [p_mass]=pipe_mass_sim_noextd(p,comps,par)
%index parameters
N=par.N; M=par.M; C=par.C; FN=par.FN; NE=par.NE; GN=par.GN;
...
Am=par.Am; Ad=par.Ad; As=par.As; R=par.R;
%variables
...
[~,N1] = size(comps);%这里的N1是指仿真的时间长度，不局限于25h，包括startup
