...
[node_data,node_text]=xlsread(fullfile(mfolder, 'input_network_nodes'));
[pipe_data,pipe_text]=xlsread(fullfile(mfolder, 'input_network_pipes'));
[comp_data,comp_text]=xlsread(fullfile(mfolder, 'input_network_comps'));
[gnode_data,gnode_text]=xlsread(fullfile(mfolder, 'input_network_gnodes'));
...
fid = fopen(fullfile(mfolder, 'input_network.txt'),'wt');
