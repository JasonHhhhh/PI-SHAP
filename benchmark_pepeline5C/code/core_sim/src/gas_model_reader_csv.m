...
%import from csv
nodedat=importdata(fullfile(mfolder, 'input_network_nodes.csv'));
pipedat=importdata(fullfile(mfolder, 'input_network_pipes.csv'));
compdat=importdata(fullfile(mfolder, 'input_network_comps.csv'));
gnodedat=importdata(fullfile(mfolder, 'input_network_gnodes.csv'));
...
fid = fopen(fullfile(mfolder, 'input_network.txt'),'w');
