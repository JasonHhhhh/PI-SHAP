...
% k_train=5; %[5 8 10 12 15] ---24(tree) ---4(level)
for k_train=[5 8 10 12 15]
...
% 添加标题
sgtitle('Comparison of $k$', ...
     'FontWeight', 'bold','Interpreter', 'latex','FontSize',20);
